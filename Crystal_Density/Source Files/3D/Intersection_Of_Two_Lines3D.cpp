...
P3 Intersection_Of_Two_Lines3D ( L3 const& l1, L3 const& l2 )
{
    ...
    if (abs( v1.x() ) > tiny_num && abs( v1.y() * v2.x() / (double)v1.x() - v2.y() ) > tiny_num)
    {
    ...
    else if (abs( v1.x() ) > tiny_num && abs( v1.z() * v2.x() / (double)v1.x() - v2.z() ) > tiny_num)
    {
    ...
    else if (abs( v1.y() ) > tiny_num && abs( v1.x() * v2.y() / (double)v1.y() - v2.x() ) > tiny_num)
    {
    ...
    else if (abs( v1.y() ) > tiny_num && abs( v1.z() * v2.y() / (double)v1.y() - v2.z() ) > tiny_num)
    {
    ...
    else if (abs( v1.x() * v2.z() / (double)v1.z() - v2.x() ) > tiny_num)
    {
